...
def get_embedding(text):
    """
    This function takes a string of text as input and returns a 1-D array 
    object that represents the embedding of the input text. The embedding is 
    generated using the SentenceTransformer model.
...
def extract_importance(persona, nodes):
  ...
  calculated (importance is the poignancy of the memory node).
